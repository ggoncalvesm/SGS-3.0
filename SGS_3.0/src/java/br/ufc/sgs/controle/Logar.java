        ...
        if((email != null) || (! email.isEmpty()) && ((senha != null) || (! senha.isEmpty()))){
            ...
            if(usuario == null){ // É verificado se a consulta no banco retornou algum registro
                ...
                if(usuario instanceof Gerente){ 
                    return "META-INF/jsp_gerente/paginaInicial.jsp";
                }else if(usuario instanceof Candidato){
                    return "META-INF/jsp_candidato/paginaInicial.jsp";
                }else{
                    return "META-INF/jsp_avaliador/paginaInicial.jsp";
                }
            }
            ...
            request.setAttribute("mensagem", "Os campos de login ou senha estão inválidos");
            return "index.jsp";
        }
