...
public class FaseDAO extends ExecutaSQL{
    ...
    public Fase getFase(int id_fase) throws SQLException{
        String sql = "SELECT id_concurso, titulo, descricao, dataInicio, dataTermino, criterioDeSelecao FROM FASE WHERE id = ?" ; 
        ...
        if(rs.next()){
            ...
            return new Fase(id_fase, titulo, descricao, dataInicio, dataTermino, null, documentosRequisitados, participantes, avaliadores);
        }return null;
    }
    ...
    public boolean cadastra(Fase fase, int id_concurso) throws SQLException{
        ...
        ps.setString(5, " "); // Modificar isso daqui em atualizar também!
